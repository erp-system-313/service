...
public class AuditLogControllerTest {
    ...
    @Test @Order(1) void testListAuditLogs() { HttpEntity<Void> req = new HttpEntity<>(getHeaders()); var r = restTemplate.exchange("http://localhost:8080/api/v1/audit-logs?page=0&size=20", HttpMethod.GET, req, new ParameterizedTypeReference<>() {}); assertThat(r.getStatusCode()).isEqualTo(HttpStatus.OK); }
}