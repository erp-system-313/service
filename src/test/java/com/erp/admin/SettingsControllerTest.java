...
public class SettingsControllerTest {
    ...
    @Test @Order(1) void testGetAllSettings() { HttpEntity<Void> req = new HttpEntity<>(getHeaders()); var r = restTemplate.exchange("http://localhost:8080/api/v1/settings", HttpMethod.GET, req, new ParameterizedTypeReference<>() {}); assertThat(r.getStatusCode()).isEqualTo(HttpStatus.OK); }
    @Test @Order(2) void testUpdateSettings() { var req = Map.of("key", "test_key", "value", "test_value"); HttpEntity<Map> request = new HttpEntity<>(req, getHeaders()); var r = restTemplate.exchange("http://localhost:8080/api/v1/settings", HttpMethod.PUT, request, new ParameterizedTypeReference<>() {}); assertThat(r.getStatusCode()).isEqualTo(HttpStatus.OK); }
}