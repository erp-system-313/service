...
public class AccountControllerTest extends BaseControllerTest {
    ...
    private void post(String u, String m) { HttpMethod method = "DELETE".equals(m) ? HttpMethod.DELETE : HttpMethod.POST; assertThat(req(u, method).getStatusCode()).isIn(HttpStatus.OK, HttpStatus.BAD_REQUEST, HttpStatus.NOT_FOUND, HttpStatus.UNAUTHORIZED); }
