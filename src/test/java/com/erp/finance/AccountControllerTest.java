...
public class AccountControllerTest {
    ...
    @Test public void testNoAuth() { assertThat(noauth("/api/v1/accounts").getStatusCode()).isEqualTo(HttpStatus.FORBIDDEN); }
    ...
    private void post(String u, String m) { HttpMethod method = "DELETE".equals(m) ? HttpMethod.DELETE : HttpMethod.POST; assertThat(req(u, method).getStatusCode()).isIn(HttpStatus.OK, HttpStatus.NOT_FOUND, HttpStatus.UNAUTHORIZED, HttpStatus.FORBIDDEN); }
