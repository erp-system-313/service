...
CREATE INDEX IF NOT EXISTS idx_crm_leads_expected_closing ON crm_leads(expected_closing);
CREATE INDEX IF NOT EXISTS idx_crm_leads_activity_date ON crm_leads(activity_date);
